...
/**
 * Kombinované angažmá - kombinace údajůPO a FO, včetně vkladu společníka (v id je slovo vklad)
 * 
 ...
 *         &lt;element name="Pravnicka_osoba" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.4}pravnicka_osoba" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Vklad_spolecnika" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.4}vklad_spolecnika" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class Angazma {
    ...
    protected PravnickaOsoba2 pravnickaOsoba;
    @XmlElement(name = "Fyzicka_osoba")
    protected FyzickaOsoba2 fyzickaOsoba;
     ...
     *     
     */
    public PravnickaOsoba2 getPravnickaOsoba() {
     ...
     *     
     */
    public void setPravnickaOsoba(PravnickaOsoba2 value) {
     ...
     *     
     */
    public FyzickaOsoba2 getFyzickaOsoba() {
        return fyzickaOsoba;
    }
     ...
     *     
     */
    public void setFyzickaOsoba(FyzickaOsoba2 value) {
