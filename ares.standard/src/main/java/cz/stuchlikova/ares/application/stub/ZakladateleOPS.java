 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Zakladatel_OPS" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.1}angazma_PO_n_FO" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "zakladatele_OPS", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.1", propOrder = {
    "zakladatelOPS",
    "text"
})
public class ZakladateleOPS {
    ...
    protected List<AngazmaPONFO> zakladatelOPS;
     ...
     * 
     */
    public List<AngazmaPONFO> getZakladatelOPS() {
        if (zakladatelOPS == null) {
            zakladatelOPS = new ArrayList<AngazmaPONFO>();
        }
