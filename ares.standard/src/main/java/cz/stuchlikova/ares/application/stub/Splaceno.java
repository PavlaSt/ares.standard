...
/**
 * Informace o splacení částky vkladu v Kč, procentech nebo volným textem
 * 
 ...
 *         &lt;element name="Procenta" type="{http://www.w3.org/2001/XMLSchema}short" minOccurs="0"/&gt;
...
@XmlType(name = "splaceno", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.1", propOrder = {
    "kc",
    "procenta",
    "ostatni"
})
public class Splaceno {
     ...
     *     
     */
    public void setProcenta(Short value) {
        this.procenta = value;
    }
