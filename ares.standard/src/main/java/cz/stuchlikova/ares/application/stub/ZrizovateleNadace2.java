 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Zrizovatel_nadace" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.4}angazma" maxOccurs="unbounded"/&gt;
...
public class ZrizovateleNadace2 {

    @XmlElement(name = "Zrizovatel_nadace", required = true)
    protected List<Angazma> zrizovatelNadace;
     ...
     * 
     */
    public List<Angazma> getZrizovatelNadace() {
        if (zrizovatelNadace == null) {
            zrizovatelNadace = new ArrayList<Angazma>();
        }
