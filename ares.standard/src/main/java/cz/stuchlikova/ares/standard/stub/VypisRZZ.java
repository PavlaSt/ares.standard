...
public class VypisRZZ {
    ...
    protected FyzickaOsoba2 fyzickaOsobaStatutar;
    @XmlElement(name = "Sidlo")
    protected AdresaARES2 sidlo;
    @XmlElement(name = "ZUJ")
    protected Zuj zuj;
     ...
     *     
     */
    public FyzickaOsoba2 getFyzickaOsobaStatutar() {
     ...
     *     
     */
    public void setFyzickaOsobaStatutar(FyzickaOsoba2 value) {
     ...
     *     
     */
    public void setSidlo(AdresaARES2 value) {
        this.sidlo = value;
    }
