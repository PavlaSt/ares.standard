 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ic" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.4}ico" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SeznamSubjektu {
     ...
     * 
     */
    public List<Ico2> getIc() {
        if (ic == null) {
            ic = new ArrayList<Ico2>();
        }
        return this.ic;
    }
