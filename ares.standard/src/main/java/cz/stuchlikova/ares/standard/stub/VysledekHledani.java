 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Kod" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.1}kod_vyhledani"/&gt;
...
@XmlType(name = "vysledek_hledani", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.1", propOrder = {
    "kod",
    "datumVzniku",
    "text"
})
