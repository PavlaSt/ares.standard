 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Clen_DR" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.1}clen_DR" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "dozorci_rada", namespace = "http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.1", propOrder = {
    "clenDR",
    "text"
})
public class DozorciRada {
     ...
     * 
     */
    public List<ClenDR> getClenDR() {
        if (clenDR == null) {
            clenDR = new ArrayList<ClenDR>();
        }
        return this.clenDR;
    }
