 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Zakladatel_SP" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.4}angazma" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ZakladateleSP2 {

    @XmlElement(name = "Zakladatel_SP")
    protected List<Angazma> zakladatelSP;
     ...
     * 
     */
    public List<Angazma> getZakladatelSP() {
        if (zakladatelSP == null) {
            zakladatelSP = new ArrayList<Angazma>();
        }
