...
public class VypisCeuDetail {
    ...
    protected StavUpadceCEU2 stavK;
    @XmlElement(name = "Stav_v")
    @XmlSchemaType(name = "string")
    protected StavUpadceCEU2 stavV;
     ...
     *     
     */
    public StavUpadceCEU2 getStavK() {
        return stavK;
    }
     ...
     *     
     */
    public void setStavK(StavUpadceCEU2 value) {
        this.stavK = value;
    }
     ...
     *     
     */
    public StavUpadceCEU2 getStavV() {
        return stavV;
    }
     ...
     *     
     */
    public void setStavV(StavUpadceCEU2 value) {
        this.stavV = value;
    }
