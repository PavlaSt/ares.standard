...
/**
 * <p>Java class for odpoved_ros complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="odpoved_ros"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Vypis_ROS" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.4}vypis_ROS" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "odpoved_ros", propOrder = {
    "pomocneID",
    "error",
    "vysledekHledani",
    "pocetZaznamu",
...
public class OdpovedRos {
    ...
    @XmlElement(name = "Vypis_ROS")
    protected List<VypisROS> vypisROS;
    ...
    /**
     * Gets the value of the vypisROS property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vypisROS property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVypisROS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<VypisROS> getVypisROS() {
        if (vypisROS == null) {
            vypisROS = new ArrayList<VypisROS>();
        }
        return this.vypisROS;
    }
