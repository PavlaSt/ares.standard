 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Provozovna" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.4}provozovna_ros" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ProvozovnyRos {
    ...
    protected List<ProvozovnaRos> provozovna;
     ...
     * 
     */
    public List<ProvozovnaRos> getProvozovna() {
        if (provozovna == null) {
            provozovna = new ArrayList<ProvozovnaRos>();
        }
