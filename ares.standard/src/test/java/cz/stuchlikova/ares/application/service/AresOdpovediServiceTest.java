...
class AresOdpovediServiceTest {
    ...
    void getDtoResponseByIco_happy_path() throws DatatypeConfigurationException {
        List<AresStandardResponseDto> dtos = service.getDtoResponseByIco("27074358");
    ...
    void getDtoResponseByIco_non_existing() {
        ...
        Assertions.assertThrows(RecordNotFoundException.class, () -> {
            List<AresStandardResponseDto> dtos = service.getDtoResponseByIco("12345678");
        });
  ...
  /*  @Test
    void getDtoResponseByIco_bad_input() throws DatatypeConfigurationException {
        ...
        Assertions.assertThrows(ConstraintViolationException.class, () -> {
            List<AresStandardResponseDto> dtos = service.getDtoResponseByIco("bad_input");
        });
    }*/
